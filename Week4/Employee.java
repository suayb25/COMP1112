...
public class Employee {
    ...
    private static double raiseRate = 0;//"by a certain percentage". You need to define a variable that belongs to the Employee class.
    ...
    public static double getRaiseRate() {
        return raiseRate;
    }

    public static void setRaiseRate(double raiseRate) {
        Employee.raiseRate = raiseRate;
    }
